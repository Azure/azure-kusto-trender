    ...
    public render(data: any, options: any, aggregateExpressionOptions: any) {
        ...
        if (this.svgSelection == null) {
            ...
            this.draw = (isFromResize = false) => {
                ...
                function pathMouseInteraction (e,d: any)  {
                    /*
                    ...
                    */
                    ...
                    drawTooltip(d, d3.pointer(e,self.svgSelection.node()));
                }
                ...
                arcEntered.each(function () {
                    ...
                    var pathEntered = pathElem.enter()
                        ...
                        .attr("d", drawArc)
                        .on("mouseover", (e,d)=>pathMouseInteraction(e,d))
                        .on("mousemove" ,(e,d)=>pathMouseInteraction(e,d))
                        .on("mouseout", (e,d)=>pathMouseout(e,d))
